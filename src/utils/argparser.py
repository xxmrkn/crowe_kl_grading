...
def get_args():
    ...
    parser.add_argument('--sign', type=str, default='20230617_test', help="Unique Sign")
    ...
    parser.add_argument('--pretrained', type=str, default=True, help='Use Pretrained Weight')
    parser.add_argument('--optimizer', type=str, default='Adam', help='Optimizer Name')
    parser.add_argument('--criterion', type=str, default='MAE Loss', help='Loss Function')
    parser.add_argument('--scheduler', type=str, default='CosineAnnealingLR', help='Learning Scheduler')
    parser.add_argument('--datalist', type=str, default='1', help="Datalist ID")
